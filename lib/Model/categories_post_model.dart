...
List<CategoriesPostModel> categoriesPostModelFromJson(String str) => List<CategoriesPostModel>.from(json.decode(str).map((x) => CategoriesPostModel.fromJson(x)));

String categoriesPostModelToJson(List<CategoriesPostModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class CategoriesPostModel {
  ...
  String yoastHead;
  CategoriesPostModelLinks links;
  Embedded embedded;

  factory CategoriesPostModel.fromJson(Map<String, dynamic> json) => CategoriesPostModel(
    id: json["id"],
    ...
    type: categoriesPostModelTypeValues.map[json["type"]],
    link: json["link"],
    ...
    links: CategoriesPostModelLinks.fromJson(json["_links"]),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "type": categoriesPostModelTypeValues.reverse[type],
    "link": link,
    "title": title.toJson(),
...
enum AuthorName { MOHAMMAD_FAIQUE, BRIJESH_SINGH }

final authorNameValues = EnumValues({
  "BRIJESH Singh": AuthorName.BRIJESH_SINGH,
  "Mohammad Faique": AuthorName.MOHAMMAD_FAIQUE
});

enum Slug { MF, BRIJESH }

final slugValues = EnumValues({
  "brijesh": Slug.BRIJESH,
  "mf": Slug.MF
});
...
class CategoriesPostModelLinks {
  CategoriesPostModelLinks({
    this.self,
    this.collection,
    this.about,
    this.author,
  ...
  factory CategoriesPostModelLinks.fromJson(Map<String, dynamic> json) => CategoriesPostModelLinks(
    self: List<About>.from(json["self"].map((x) => About.fromJson(x))),
    collection: List<About>.from(json["collection"].map((x) => About.fromJson(x))),
    about: List<About>.from(json["about"].map((x) => About.fromJson(x))),
    author: List<ReplyElement>.from(json["author"].map((x) => ReplyElement.fromJson(x))),
...
enum CategoriesPostModelType { POST }

final categoriesPostModelTypeValues = EnumValues({
  "post": CategoriesPostModelType.POST
});
