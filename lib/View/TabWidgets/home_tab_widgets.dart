...
class _HomeTabWidgetState extends State<HomeTabWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    Container(
      ...
      Container(height: sSize.height * 0.1,
      width: sSize.width,
        child: Text("Latest News",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25),),
      ),
      Expanded(
        child: FutureBuilder(
                    ...
                    if(snapshot.hasError){
                      ...
                      return new ListView.builder(
                        ...
                        itemBuilder: (context,index){
                          return new MyWidgets().postCard(sSize: sSize, title: snapshot.data[index].toString(), thumbnail: "");
                        },
